        ...
        ColumnLayout {
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    height: innerRow.implicitHeight + island.s(16)
                    radius: island.s(12)
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            radius: island.s(17); clip: true; Layout.alignment: Qt.AlignVCenter
                            color: Qt.rgba(notifDelegate.accentColor.r, notifDelegate.accentColor.g, notifDelegate.accentColor.b, 0.12)
                            Image {
                                id: histIcon; anchors.fill: parent; anchors.margins: island.s(1)
                                source: {
                                    let ic = model.icon || ""
                                    if (ic === "") return ""
